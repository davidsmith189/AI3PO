...
class OpenAIService(private val context: Context, private val onResponse: (String) -> Unit = {}) {
    ...
    private val apiKey = "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"
