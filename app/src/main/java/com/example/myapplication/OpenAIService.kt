...
class OpenAIService(private val context: Context, private val onResponse: (String) -> Unit = {}) {
    ...
    private val apiKey = "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"
